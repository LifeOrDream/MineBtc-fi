...
pub struct MineBtcUnstaked {
    ...
    // Post-update player state (see MineBtcStaked for rationale).
    pub new_degenbtc_sol_reward_debt: u128,
    pub new_degenbtc_dbtc_reward_debt: u128,
    pub total_pending_sol_rewards: u64,
    pub total_pending_staking_dbtc_rewards: u64,
    pub timestamp: i64,
}
...
pub struct LiquidityStaked {
    ...
    pub new_lp_dbtc_reward_debt: u128, // = faction.lp_degenbtc_reward_index after update
    pub total_pending_sol_rewards: u64,
    pub total_pending_staking_dbtc_rewards: u64,
    pub timestamp: i64,
}
...
pub struct LiquidityUnstaked {
    ...
    pub returned_amount: u64,
    // Post-update player state (see MineBtcStaked).
    pub new_lp_sol_reward_debt: u128,
    pub new_lp_dbtc_reward_debt: u128,
    pub total_pending_sol_rewards: u64,
    pub total_pending_staking_dbtc_rewards: u64,
    pub timestamp: i64,
}
