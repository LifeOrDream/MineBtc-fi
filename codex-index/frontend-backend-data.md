...
- HashBeast inventory, HashBeast metadata, staked HashBeasts, gameplay HashBeast, free mint allowance.
...
- Active users, unique bettors, unique HashBeast minters, unique autominer users.
- SOL volume by round/day/cycle.
- degenBTC rewards distributed/mined/claimed.
- HashBeast genesis mints by faction and revenue.
...
- `hashbeasts:mints` - public HashBeast mint stream.
...
- `GET /api/leaderboards/*` - factions, referrals, users, HashBeasts.
