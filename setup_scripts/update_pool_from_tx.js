...
// vault_1 = 99,000 DegenBTC (99,000,000,000 with 6 decimals)
const INITIAL_SOL_AMOUNT = "1000000000"; // 1 SOL
const INITIAL_DBTC_AMOUNT = "99000000000"; // 99,000 DegenBTC
...
async function main() {
  ...
  console.log("\x1b[36m%s\x1b[0m", `   Token0: ${token0Mint.toBase58()} ${isMdogeToken0 ? "(DegenBTC)" : "(WSOL)"}`);
  console.log("\x1b[36m%s\x1b[0m", `   Token1: ${token1Mint.toBase58()} ${!isMdogeToken0 ? "(DegenBTC)" : "(WSOL)"}`);
  ...
  deploymentData.dbtc_sol_pool_created = {
    ...
    initialMdogeReadable: "99,000 DegenBTC",
  ...
  console.log("\x1b[36m%s\x1b[0m", `Token0 (${isMdogeToken0 ? "DegenBTC" : "WSOL"}): ${token0Mint.toBase58()}`);
  console.log("\x1b[36m%s\x1b[0m", `Token1 (${!isMdogeToken0 ? "DegenBTC" : "WSOL"}): ${token1Mint.toBase58()}`);
  ...
  console.log("\x1b[36m%s\x1b[0m", `Initial Liquidity: 1 SOL + 99,000 DegenBTC`);
  console.log("\x1b[35m%s\x1b[0m", "====================================================");
}
